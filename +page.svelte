...
<div>
    <!-- Search Bar -->
    <div class="mt-25 flex justify-center px-4">
    ...
    <!-- Filter Buttons -->
    <div class="mt-1 flex justify-center px-4">
        <div class="w-full max-w-7xl flex flex-wrap items-center gap-2">
            <span class="mr-1 whitespace-nowrap">Show:</span>
            ...
            {/each}
            {#if filters.some(f => f.selectedOpts.length > 0)}
                <RedButton onclick={clearAllFilters}>
                    <Icon icon="tabler:x" class="mr-1 h-5 w-5" />
    ...
    <div class="flex justify-center px-4">
        {#if selectedIds.length > 0}
            <div class="mt-6 flex w-full max-w-7xl flex-col gap-4 sm:flex-row sm:justify-between">
        ...
        {:else}
            <div class="mt-6 flex w-full max-w-7xl flex-col justify-between gap-4 sm:flex-row">
                <GreenButton onclick={() => (isExportModalOpen = true)}>
                    <Icon icon="tabler:file-export" class="mr-2 h-5 w-5" />
                    <span>Export Reports</span>
                </GreenButton>
    ...
    <div class="custom-scrollbar mt-2.5 w-full overflow-x-auto px-4" data-testid="faculty-record-list">
        <div class="min-w-5xl pb-4">
            <!-- Header -->
            <div
    ...
    <!-- Pagination Controls -->
    <div class="mt-2 flex justify-center px-4 pb-10">
